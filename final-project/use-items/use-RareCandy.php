...
<html>
	...
	<body>
		<?php
			...
			$query = "select quantity from inventory where item_id = 5";
		...
		?>
				<div class="content">
					<?php
						...
						include("../sidebar.php");
					?>
					<p class="use-item">You have no Rare Candies to use.</p>
				</div>
		<?php
			}
			else {
			...
			<div class="content">
				<?php
					...
					include("../sidebar.php");
				?>
				<p class="use-item">You used a Rare Candy on your Pokemon. Its happiness increased by 30.</p>
			</div>
		<?php
			}
			$db = NULL;
