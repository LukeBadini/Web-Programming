...
<html>
	...
	<body>
		<?php
			...
			$query = "select quantity from inventory where item_id = 2";
		...
		?>
				<div class="content">
					<?php
						...
						include("../sidebar.php");
					?>
					<p class="use-item">You have no Sitrus Berries to use.</p>
				</div>
		<?php
			}
			else {
			...
			<div class="content">
				<?php
					...
					include("../sidebar.php");
				?>
				<p class="use-item">You used a Sitrus Berry on your Pokemon. Its hunger has been restored by 30.</p>
			</div>
		<?php
			}
			$db = NULL;
